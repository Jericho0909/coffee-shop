...
const UserSettings = ({user}) => {
    ...
    const Layout = (title1, value1, title2, value2) => {
        return(
    ...
    return(
        <div className="container-flex justify-start flex-col w-full h-[90%] sm:w-[80%] lg:w-[100%] xl:w-[90%] py-[2rem] xl:py-[0.50rem] px-1 ">
            ...
            <section className="w-full h-auto p-1">
                ...
                {Layout("Username:", user.username, "Password:", password)}
                {Layout("Phone:", user.phone, "Email:", user.email)}
            ...
            <section>
                ...
                {Layout("Date Joined:", user.dateJoined, "Last Order Date:", user.lastOrderDate)}
                {Layout("Total Orders:", user.totalOrders, "Total Spent:", user.totalSpent)}
            </section>
